  ...
  if (suggestedFilename) {
    ...
    if (suggestedFilename.indexOf('%') !== -1) {
      ...
      try {
        ...
        // URIError "Malformed URI", e.g. for "http://mozilla.github.io/pdf.js/web/%AA.pdf"
        // TypeError "null has no properties", e.g. for "http://mozilla.github.io/pdf.js/web/%2F.pdf"
      }
    }
  }
  return suggestedFilename || 'http://mozilla.github.io/pdf.js/web/document.pdf';
}
